...
*Visualizar KPIs (total de voos, atrasados e % de atraso).
*Rankear Top 10 aeroportos por volume de atrasos.
*Comparar companhias x ano (Top 10).
...
*Companhias x ano (Top 10).
*Atrasos por dia da semana (Seg…Dom).
*Atrasos por período do dia (Madrugada/Manhã/Tarde/Noite).
*Tendência de aumento (2022→2024): mostra somente aeroportos com evolução consistente de atrasos (2023 ≥ 2022 e 2024 > 2023).

🧪 Troubleshooting
*ModuleNotFoundError (ex.: seaborn)
Instale a dependência: pip install seaborn.
*Streamlit não abre automaticamente
Copie a URL do terminal e cole no navegador.
*Erro de leitura de CSV
Verifique separador/encoding. O app já tenta ;/, e encodings comuns.
